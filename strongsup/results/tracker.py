...
class TopLevelTracker(Tracker):
    ...
    def entries(self, dataset_filters=None, experiment_type_filters=None):
        ...
        trackers = filter(filter_fn, self._trackers.itervalues())
        entries = []
    ...
    def merge(self, other):
        for dataset, tracker in other._trackers.iteritems():
    ...
    @property
    def datasets(self):
        return self._trackers.iterkeys()
...
class LeafTracker(Tracker):
    ...
    def entries(self, experiment_type_filters=None):
        ...
        entries = filter(filter_fn, self._entries.itervalues())
        return entries
    ...
    def merge(self, other):
        for (experiment_type, entry) in other._entries.iteritems():
